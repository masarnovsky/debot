...
const val REVERT_WAS_COMPLETED = "Запись <b>%.2f %s за %s</b> была удалена"
const val WRONG_FORMAT_FOR_REVERT_COMMAND = "Формат комманды должен быть <b>/revert имя</b>"
const val DELETE_LAST_DEBTOR_LOG = "Удалить последнюю запись %s: <b>%.2f</b> за <i>%s</i>?"
const val WRONG_FORMAT_FOR_MERGE_COMMAND =
    "Формат комманды должен быть <b>/merge имя_источника имя_получателя</b>"
...
const val DELETE_MERGED_DEBTOR_BUTTON = "Удалить записи %s"
...
Если нужно удалить последнюю запись должника:
<b>/revert имя</b>
