...
const val DEBTOR_RECORD = "Долг %s равен %.2f %s за: <b>%s</b>\n<i>Посмотреть всех:</i> /all"
const val DEBTOR_RETURN_RECORD = "%s вернул(а) %.2f %s и теперь"
const val DEBTOR_ZERO_CREDIT = " ничего не должен(на)"
const val DEBTOR_CREDIT_AFTER_REPAY = " должен(на) тебе %.2f %s за: <b>%s</b>"
const val DEBTOR_SUGGESTION_FOR_INLINE_QUERY = "Долг %s равен %.2f %s"
const val DEBTOR_RECORD_FOR_INLINE_QUERY = "Долг %s равен %.2f %s за: <b>%s</b>"
const val DEBTOR_RECORD_SHORT = "%s %.2f %s за: <b>%s</b>"
...
const val DEBTOR_LOG_HISTORY_HEADER = "Текущий долг для %s равняется %.2f %s\nИстория долгов:\n"
const val LOG_SUMMARIZE = "%s |   %.2f за %s\n"
const val YES = "Да"
const val NO = "Нет"
const val SHOW_MERGED_DEBTOR_BUTTON = "Показать долги %s"
const val CURRENT_DEBTS_TOTAL_AMOUNT = "Общая сумма долгов равна %.2f %s\n"
const val DEBTOR_HISTORICAL_CREDIT = "За все время вы одолжили %s %.2f %s\n"
